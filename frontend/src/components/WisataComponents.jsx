    ...
    <div id="slide-container" style={{ position: "relative", width: "100%" }}>
      ...
      >
        <div className="column">
          <img src="/assets/wisata/1.png" alt="Wisata 1" />
        ...
        <div className="column">
          <img src="/assets/wisata/wisata2.png" alt="Wisata 2" />
        ...
        <div className="column">
          <img src="/assets/wisata/wisata3.png" alt="Wisata 3" />
      ...
      >
        <div className="column">
          <img src="/assets/wisata/wisata4.png" alt="Wisata 4" />
        ...
        <div className="column">
          <img src="/assets/wisata/wisata5.png" alt="Wisata 5" />
        ...
        <div className="column">
          <img src="/assets/wisata/wisata6.png" alt="Wisata 6" />
      ...
      <button onClick={prevSlide} className="slide-button-wisata left-butt-wisata">
        <img src="/assets/wisata/button.png" alt="" />
      </button>
